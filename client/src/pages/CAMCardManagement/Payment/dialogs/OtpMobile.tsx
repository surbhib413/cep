			...
			<Dialog disableBackdropClick  disableEscapeKeyDown fullScreen={fullScreen} open={props.open} onClose={handleClose} aria-labelledby="otp-dialog-title">
				...
				<DialogContent>
					...
					<div className={classes.otpContent1}>
						An OTP (One Time Password) has been sent to </div>
					<DialogContentText className={classes.otpContent}>
						your number<span className={classes.bold}>{props.customerMobile}</span>
					</DialogContentText>
					...
					<div style={{ margin: "1rem 0px" }}>
						...
						<Success open={resendMsg} onClose={() => setResendMsg(false)}>OTP resent to {props.customerMobile}</Success>
					</div>
				</DialogContent>
			</Dialog>
			{/* </Hidden> */}
