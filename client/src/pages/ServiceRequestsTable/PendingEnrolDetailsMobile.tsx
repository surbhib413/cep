...
export default function PendingEnrolDetailsMobile(props: any) {
          ...
          <div className={`d-flex mt-2 justify-content-around`}>
            <CustomGrid container spacing={2}>
              <CustomGrid item xs={5}>
                <span className={`${scssStyles.colLabels}`}>User ID </span>
              </CustomGrid>
              ...
              <CustomGrid item xs={7}>
                <span className={`${scssStyles.colValues}`}>Step 3 of 7</span>
              </CustomGrid>
            </CustomGrid>
          </div>
        </DialogContent>
