...
const EnrolSuccess = (props: { history: any }): JSX.Element => {
  ...
  const redirectToResetPassword = (): void => {
    ...
    // });
    router.push({ pathname: "/resetpassword", query: { setPassword: true } });
  };
              ...
              {store.assistedFlow ? (
                ""
                  ...
                  <Typography className={styles.mobileTitle}>
                    ...
                    <p>in SmartFleet Loyalty Program</p>
                  </Typography>
                )}
            </div>
          </div>
          <img className="" src={mobileIcon} alt="" />
        </Hidden>

        <Hidden xsDown>
          <img className="" src={applicationDescIcon} alt="" />
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={4}>
                  <div className={`d-flex justify-content-center`}>
                    ...
                    <Typography className={styles.labelStyle}>
                      <span className={`${styles.subTitle}`}>FA ID</span>
                      <p className={`pt-2 ${styles.subLabel}`}>FA9722334412</p>
                    </Typography>
                  </div>
                </Grid>
                <Grid item xs={12} sm={4}>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={5}>
                  <div className={`d-flex`}>
                    ...
                    <span className={`${styles.mobileSubTitle}`}>FA ID </span>
                  </div>
                </Grid>
