...
const SubmitApplicationFeePaid = (props: { history: any }): JSX.Element => {
      ...
      <Hidden smUp>
        ...
        >
          ...
          <div className={`d-flex justify-content-center align-items-center mt-4`}>
            ...
            <Typography className="pt-4">
              <p className={`${styles.mobileSubLabel} ${styles.bold}`}>
                The request for enrollment would be subject to the Bharat
              ...
              ""
                ...
                <Typography className="p-2">
                  <span className={`${styles.subSpanLabel}`}>
                    We request you to be patient while we{" "}
                  </span>
            ...
            >
              <CustomButton
                color="primary"
                id="submitfeepaid-applicationpdf"
                variant="contained"
                className={`w-100`}
              ...
              {store.assistedFlow ? (
                <CustomButton
                  color="primary"
                  id="submitfeepaid-reviewapplication"
                  variant="outlined"
                ...
                >
                  ...
                  <CustomButton
                    color="primary"
                    id="submitfeepaid-editapplication"
                    variant="outlined"
                    className={`w-100 mt-3`}
                    onClick={() => redirectToForm()}
                  >
              ...
              >
                {store.assistedFlow ? (
                  <span
                    ...
                    id="submitfeepaid-servicerequest"
                  >
      ...
      <Hidden xsDown>
        ...
        >
          ...
          <div className={`d-flex justify-content-center align-items-center mt-4`}>
            ...
            <Typography className="pt-4">
              <p className={`${styles.spanLabel} ${styles.bold}`}>
                The request for enrollment would be subject to the Bharat
                Petroleum's Approval{" "}
              </p>
            </Typography>
            {store.assistedFlow ? (
              ""
                ...
                <Typography className="p-2">
                  <span className={`${styles.subSpanLabel}`}>
                    We request you to be patient while we process your request!{" "}
                  </span>
                </Typography>
              )}
            <Box
...
export default SubmitApplicationFeePaid;
